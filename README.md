...
| /notify | [Option] | [VAL1] [VAL2] | Notify all or some users.<br /> **all** send [VAL1] as a direct message to all users.<br /> **allbut** send direct message to every user but those specified by the csv file specified by [VAL1] ( The usernames should be on the second column ). [VAL2] : the desired message to be sent.                                                                                                              |
